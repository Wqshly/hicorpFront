<template>
  <div class="fill-container scroll-style">
    <div class="table-container-style">
      <div id="test1" style="width: 1300px;height:400px;"></div>
    </div>
    <el-row>
      <el-col :span="12">
        <div class="table-container-style">
    ...
    <div class="table-container-style">
      <div id="test4" style="width: 1300px;height:400px;"></div>
    </div>
  </div>
</template>
  ...
  data () {
    ...
    return {
        ...
        series: [
          {
            ...
            data: [120, 132, 101, 134, 90, 34, 90, 230, 210, 90, 230, 210]
          },
          {
            name: '升温',
            type: 'line',
            ...
            data: [220, 182, 191, 234, 191, 234, 290, 330, 310, 290, 330, 310]
          },
          {
            name: '恒温',
            type: 'line',
            ...
            data: [150, 232, 232, 201, 154, 190, 330, 330, 410, 190, 330, 410]
          },
          {
            name: '降温',
            type: 'line',
            ...
            data: [320, 332, 301, 332, 301, 334, 390, 330, 320, 390, 330, 320]
          },
          {
            name: '大气',
            type: 'line',
            ...
            data: [820, 932, 901, 934, 1290, 1330, 1290, 1330, 934, 1290, 1330, 1320]
          }
        ]
      },
      option2: {
      ...
      option4: {
        ...
        options: [
          {
            title: {text: '2002经济指标 动态数据展示(右侧可选)'},
            series: [
          ...
          {
            title: {text: '2003经济指标 动态数据展示(右侧可选)'},
            series: [
          ...
          {
            title: {text: '2004经济指标 动态数据展示(右侧可选)'},
            series: [
          ...
          {
            title: {text: '2005经济指标 动态数据展示(右侧可选)'},
            series: [
          ...
          {
            title: {text: '2006经济指标 动态数据展示(右侧可选)'},
            series: [
          ...
          {
            title: {text: '2007经济指标 动态数据展示(右侧可选)'},
            series: [
          ...
          {
            title: {text: '2008经济指标 动态数据展示(右侧可选)'},
            series: [
          ...
          {
            title: {text: '2009经济指标 动态数据展示(右侧可选)'},
            series: [
          ...
          {
            title: {text: '2010经济指标 动态数据展示(右侧可选)'},
            series: [
          ...
          {
            title: {text: '2011经济指标 动态数据展示(右侧可选)'},
            series: [
