...
export default {
  ...
  data () {
    return {
      refName: 'WarehouseCategoryForm',
      fileName: 'WarehouseCategory.xlsx',
      url: {
        refreshUrl: '/basicCategoryData/list/warehouseCategory',
        searchUrl: '/basicCategoryData/list/warehouseCategory',
      ...
      tableHeaderList: [
        ...
        {value: 'number', label: '类别编号', minWidth: 200},
  ...
  methods: {
    ...
    async addRecord () {
      this.addForm.type = 'warehouseCategory'
    ...
    async editRecord () {
      this.editForm.type = 'warehouseCategory'
