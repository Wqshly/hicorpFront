...
export default {
  ...
  data () {
    return {
      refName: 'MoldCategoryForm',
      fileName: 'MoldCategory.xlsx',
      url: {
        refreshUrl: '/basicCategoryData/list/moldCategory',
        searchUrl: '/basicCategoryData/list/moldCategory',
  ...
  methods: {
    ...
    async addRecord () {
      this.addForm.type = 'moldCategory'
    ...
    async editRecord () {
      this.editForm.type = 'moldCategory'
    ...
    getJsonList (data) {
      for (let i = 0; i < data[0].length; i++) {
        ...
        this.jsonList[i] = {}
        this.jsonList[i].name = data[0][i]['模具名称']
